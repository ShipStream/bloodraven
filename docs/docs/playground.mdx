...
<img src={require('/static/img/infographics/playground.webp').default} alt="playground infographic" />
...
| `./playground/enable-encryption.sh` | Turning on [data-at-rest encryption](./encryption-at-rest.mdx) on a playground created with `BLOODRAVEN_SETUP_TLS=1` |
