...
The strictest lower bound on RPO is the replication lag at the moment
of failure. That lag is surfaced three ways:
...
Step 2 of the [failover sequence](./failover.mdx#failover-sequence) is
