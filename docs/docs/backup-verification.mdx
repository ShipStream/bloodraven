...
<img src={require('/static/img/infographics/backup-verification.webp').default} alt="backup verification infographic" />
...
[Backup encryption: Verification](./backup-encryption.mdx#verification).
...
[kubectl plugin reference](./kubectl-plugin.mdx#verify-backup).
