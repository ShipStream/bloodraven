...
| Secret storage is protected | MySQL, TLS, S3, and encryption secrets remain confidential. |
...
Four identities participate in the data path. Everything else in the
...
confirmation interlock) or an unscheduled failover. RBAC on the CRD
