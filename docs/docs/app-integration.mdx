...
For planned Dragonfly image upgrades that can tolerate a short cache/session outage, configure native snapshot restore before using the future snapshot-upgrade workflow:
