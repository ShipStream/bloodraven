...
<img src={require('/static/img/infographics/backup-restore.webp').default} alt="backup restore infographic" />
...
:::tip Quick setup guides
Use [S3 Backups](./backup-s3.mdx) or [PVC Backups](./backup-pvc.mdx) for copy-paste setup. This page is the deep behavior reference for source selection, retention, verification, PITR, restore semantics, and failure modes.
:::
