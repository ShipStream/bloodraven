...
<img src={require('/static/img/infographics/production-install-examples.webp').default} alt="production install examples infographic" />
...
:::tip Guided install
Use [Production Install](./install-production.mdx) for the ordered production installation path. This page keeps larger snippets that are referenced from that guide.
:::
...
Pair this with the [production hardening checklist](./production-hardening.mdx)
and [known limitations](./known-limitations.mdx) before deploying real
tenant data.
