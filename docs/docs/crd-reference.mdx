...
| `pitr` | PITRStatus | Reserved summary of the continuous binlog archive. The v1alpha1 controller does not yet populate this field; live archiver health is exposed on the sidecar HTTP server at `/archiver/status`. |
