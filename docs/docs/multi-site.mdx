...
Manual promotion is required (future: the [planned-failover
API](../WISHLIST.md#11-graceful-planned-failover-api) will cover the
...
- Multi-site-aware planned failover (`kubectl annotate ...
  planned-failover=<site>`) is tracked in
  [WISHLIST.md#11](../WISHLIST.md).
