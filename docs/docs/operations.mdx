...
See the [Upgrade and version-skew policy](./upgrade-policy.mdx) for the supported MySQL baseline, how the 9.6 → 9.7 transition works, and the cross-site and sidecar ↔ operator skew contract.
