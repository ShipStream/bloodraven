...
![troubleshooting infographic](/img/infographics/troubleshooting.webp)

Use this page by symptom. If an alert fired, start with [Alert To Runbook Map](/docs/observability/alert-runbook-map).
...
**See also:** [Getting Started](/docs/get-started/getting-started), [Placement Contract](/docs/configuration/placement-contract), [CRD Reference](/docs/configuration/crd-reference).
...
**See also:** [Placement Contract](/docs/configuration/placement-contract).
...
kubectl logs -n orders pod/<mysql-pod> -c sidecar --previous
...
**See also:** [Credentials And TLS](/docs/configuration/credentials-and-tls), [Failure Mode Matrix](/docs/operations/failure-mode-matrix).
...
**See also:** [Failover](/docs/operations/failover), [Network Partitions](/docs/operations/network-partitions).
...
**See also:** [Runbooks](/docs/operations/runbooks#dns-failover-stuck), [App Integration](/docs/configuration/app-integration).
...
**See also:** [Runbooks](/docs/operations/runbooks#dragonfly-degraded), [App Integration](/docs/configuration/app-integration), [Monitoring](/docs/observability/monitoring#available-metrics).
...
**See also:** [App Integration](/docs/configuration/app-integration), [Network Partitions](/docs/operations/network-partitions).
...
**See also:** [Monitoring](/docs/observability/monitoring), [Durability And RPO](/docs/architecture/durability-and-rpo).
...
**See also:** [Runbooks](/docs/operations/runbooks#divergent-old-primary-recovery).
...
**See also:** [Runbooks](/docs/operations/runbooks#divergent-old-primary-recovery), [Durability And RPO](/docs/architecture/durability-and-rpo).
...
**See also:** [S3 Backups](/docs/backup-and-restore/backup-s3), [PVC Backups](/docs/backup-and-restore/backup-pvc).
...
**See also:** [Backup And Restore](/docs/backup-and-restore/backup-restore), [Backup Encryption](/docs/backup-and-restore/backup-encryption).
...
**See also:** [Prometheus Setup](/docs/observability/monitoring-prometheus), [Grafana Dashboards](/docs/observability/monitoring-grafana).
...
**See also:** [Security Model](/docs/configuration/security-model), [Production Install](/docs/get-started/install-production).
