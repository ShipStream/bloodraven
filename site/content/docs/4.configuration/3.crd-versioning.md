---
title: CRD versioning and migration plan
---

![crd versioning infographic](/img/infographics/crd-versioning.webp)
...
| Change log/event contract | Update [Log schema](/docs/observability/log-schema) and release notes in the same PR. |
