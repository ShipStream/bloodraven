...
Canonical checklist: `site/content/docs/8.observability/6.observability-change-checklist.md`
...
- Structured-log Event compatibility notes: (`msg`, fields, compatibility impact, `log-schema.md` update)
